...
def encode(config, collection, shared_lists, shared_queues, verbose: int = 0):
...
class CollectionIndexer():
    ...
    '''
    def __init__(self, config: ColBERTConfig, collection, verbose=0):
    ...
    def train(self, shared_lists):
        ...
        codec = ResidualCodec(config=self.config, centroids=centroids, avg_residual=avg_residual, bucket_cutoffs=bucket_cutoffs, bucket_weights=bucket_weights)
