...
from colpali.interpretability.similarity_map_utils import normalize_similarity_map
...
def plot_all_similarity_maps(
    ...
    ```python
    >>> from colpali.interpretability.similarity_map_utils import get_similarity_maps_from_embeddings
